...
const flashcardData = [
  { english: "Bonjour", french: "Hello" },
  { english: "Au revoir", french: "Goodbye" },
  { english: "Merci", french: "Thank you" },
  { english: "S'il vous plaît", french: "Please" },
  { english: "Le chat", french: "The cat" },
  { english: "La maison", french: "The house" },
  { english: "Le livre", french: "The book" },
  { english: "L'école", french: "The school" },
];
          ...
          <div className="flex flex-col items-center justify-center h-64">
            ...
            >
              ...
              <div className="absolute w-full h-full flex items-center justify-center font-semibold text-lg bg-secondary text-foreground rotate-y-180 backface-hidden">
                {isFlipped ? currentCard.french : currentCard.english}
              </div>
            </div>
          </div>
